    ...
    <section class="bg-gray-100 border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="container mt-5">
          <div class="text">
            <h3>1. Sekilas Tentang Beasiswa Pendidikan Indonesia</h3>
            <p>Program Beasiswa Pendidikan Indonesia (BPI) di lingkungan Kementrian Pendidikan dan Kebudayaan (Kemdikbud) adalah Program beasiswa Pemerintahan Indonesia berdasarkan amanat Dewan Penyantuan LDPP oleh (Lembaga Pengelola Dana Pendidikan) dan Keputusan menteri Pendidikan dan Kebudayaan yang dilaksanakan oleh Kemdikbud melalui pusat layanan pembiayaan  pendidikan (puslapdik) dan/unit-unit utama di lingkungan Kemdikbud yang didnai oleh LPDP</p>
    
            <br>
    
            <h3>2. Tujuan</h3>
            <p>a) Beasiswa Pendidikan Indonesia bertujuan untuk meningkatkan kemampuan dan kompetensi sumber daya manusia Indonesia yang mendukung percepatan pembangunan Negara Kesatuan Republik Indonesia.</p>
            <p>b) Mengoptimalkan pemanfaatan Dana Pengembangan Pendidikan Nasional (DPPN) yang ada di LPDP melalui pemverian beasiswa bergelar (degree) untuk jenjang pendidikan S1,S2 dan S3 dan non-gelar (non-degree) bagi warga Negara Indonesia yang memenuhi persyaratan di Perguruan Tinggi terbaik di dalam negeri atau di luar negeri</p>
          </div>
