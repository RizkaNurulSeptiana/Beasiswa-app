...
<html lang="en">
  <head>
    ...
    <title>Beasiswa App | Contact</title>
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
              Email     : pengaduan@kemendikbud.go.id<br /><br />
              Facebook  : Puspalit Kemendikbud RI<br /><br />
              Twitter   : @puslapdik<br /><br />
              Instagram : puslapdi_dikbud<br /><br />
              Youtube   : puslapik Kemendikbud RI<br /><br />
      ...
      <div class="container mx-auto mt-8 px-8">
        <div class="w-full flex flex-col md:flex-row py-6">
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              <li class="mt-4 inline-block mr-6 md:block md:mr-0">
                <a
                  href="#"
                  class="font-light no-underline hover:underline text-white-800 hover:text-orange-500"
                  >Official Blog</a
