    ...
    <section class="bg-gray-100 border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-1">
            <div class="container-fluid">
                <h3 class="text-2xl text-gray-800 font-bold leading-none mb-2">
                    PILIH BEASISWA YANG DIBUTUHKAN
                  </h3>
                  <p class="text-gray-600 mb-8">
                      <table align="center" width="100" border="2" bordercolor="#000000" cellpadding="40" >
                      <tbody>
                          <tr bgcolor="#75C5E6">
                              <th scope="col">Beasiswa SD &nbsp; Untuk seluruh pelajar Indonesia</th>
                              <th scope="col">Beasiswa SMP &nbsp; Untuk seluruh pelajar Indonesia</th>
                              <th scope="col">Beasiswa SMA/SMK/MA &nbsp; Untuk seluruh pelajar Indonesia</th>
                              <th scope="col">Beasiswa D3/D4/S1 &nbsp; Untuk seluruh pelajar Indonesia</th>
                              <th scope="col">Beasisiwa S2 &nbsp; Untuk seluruh pelajar Indonesia</th>
                              <th scope="col">Beasisiwa S3 &nbsp; Untuk seluruh pelajar Indonesia</th>
                            </tr>
                            
                            <tr>
                                <td><button><a href="https://pip.kemdikbud.go.id/home" type="button" class="btn btn-sm">Pilih</a></button></td>
                                <td><button><a href="https://pip.kemdikbud.go.id/home" type="button" class="btn btn-sm">Pilih</a></button></td>
                                <td><button><a href="https://pip.kemdikbud.go.id/home" type="button" class="btn btn-sm">Pilih</a></button></td>
                                <td><button><a href="https://beasiswa.kemdikbud.go.id/program/" type="button" class="btn btn-sm">Pilih</a></button></td>
                                <td><button><a href="https://beasiswa.kemdikbud.go.id/program/" type="button" class="btn btn-sm">Pilih</a></button></td>
                                <td><button><a href="https://beasiswa.kemdikbud.go.id/program/" type="button" class="btn btn-sm">Pilih</a></button></td>
                            </tr>
                        </tbody>
